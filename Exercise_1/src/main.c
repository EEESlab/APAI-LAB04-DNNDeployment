...
int main () {
  ...
  int args[4];
  args[0] = (unsigned int) IN_INT8;
  args[1] = (unsigned int) WEIGHT_INT8;
  args[2] = (unsigned int) OUT;
  args[3] = (unsigned int) IM2COL;
